      ...
      metadata: {
        ...
        initializers: {
          ...
          result: {
            // StatusDetails is a set of additional properties that MAY be set by the server to provide additional information about a response. The Reason field of a Status object defines what attributes will be set. Clients must ignore fields that do not match the defined type of each attribute, and should assume that any attribute may be empty, invalid, or under defined.
            details: {
              withCauses(causes): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { causes: if std.isArray(v=causes) then causes else [causes] } } } } } } },
              withCausesMixin(causes): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { causes+: if std.isArray(v=causes) then causes else [causes] } } } } } } },
              withGroup(group): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { group: group } } } } } } },
              withKind(kind): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { kind: kind } } } } } } },
              withName(name): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { name: name } } } } } } },
              withRetryAfterSeconds(retryAfterSeconds): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { retryAfterSeconds: retryAfterSeconds } } } } } } },
              withUid(uid): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { uid: uid } } } } } } }
            },
            withCode(code): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { code: code } } } } } },
            withKind(kind): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { kind: kind } } } } } },
            withMessage(message): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { message: message } } } } } },
            withMetadata(metadata): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { metadata: metadata } } } } } },
            withReason(reason): { spec+: { jobTemplate+: { metadata+: { initializers+: { result+: { reason: reason } } } } } }
          },
          withPending(pending): { spec+: { jobTemplate+: { metadata+: { initializers+: { pending: if std.isArray(v=pending) then pending else [pending] } } } } },
          withPendingMixin(pending): { spec+: { jobTemplate+: { metadata+: { initializers+: { pending+: if std.isArray(v=pending) then pending else [pending] } } } } }
        },
          ...
          metadata: {
            ...
            initializers: {
              ...
              result: {
                // StatusDetails is a set of additional properties that MAY be set by the server to provide additional information about a response. The Reason field of a Status object defines what attributes will be set. Clients must ignore fields that do not match the defined type of each attribute, and should assume that any attribute may be empty, invalid, or under defined.
                details: {
                  withCauses(causes): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { causes: if std.isArray(v=causes) then causes else [causes] } } } } } } } } },
                  withCausesMixin(causes): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { causes+: if std.isArray(v=causes) then causes else [causes] } } } } } } } } },
                  withGroup(group): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { group: group } } } } } } } } },
                  withKind(kind): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { kind: kind } } } } } } } } },
                  withName(name): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { name: name } } } } } } } } },
                  withRetryAfterSeconds(retryAfterSeconds): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { retryAfterSeconds: retryAfterSeconds } } } } } } } } },
                  withUid(uid): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { uid: uid } } } } } } } } }
                },
                withCode(code): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { code: code } } } } } } } },
                withKind(kind): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { kind: kind } } } } } } } },
                withMessage(message): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { message: message } } } } } } } },
                withMetadata(metadata): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { metadata: metadata } } } } } } } },
                withReason(reason): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { reason: reason } } } } } } } }
              },
              withPending(pending): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { pending: if std.isArray(v=pending) then pending else [pending] } } } } } } },
              withPendingMixin(pending): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { pending+: if std.isArray(v=pending) then pending else [pending] } } } } } } }
            },
