    ...
    metadata: {
      ...
      initializers: {
        ...
        result: {
          ...
          details: {
            withCauses(causes): { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { causes: if std.isArray(v=causes) then causes else [causes] } } } } } },
            withCausesMixin(causes): { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { causes+: if std.isArray(v=causes) then causes else [causes] } } } } } },
            withGroup(group): { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { group: group } } } } } },
            withKind(kind): { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { kind: kind } } } } } },
            withName(name): { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { name: name } } } } } },
            withRetryAfterSeconds(retryAfterSeconds): { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { retryAfterSeconds: retryAfterSeconds } } } } } },
            withUid(uid): { jobTemplate+: { metadata+: { initializers+: { result+: { details+: { uid: uid } } } } } }
          },
          withCode(code): { jobTemplate+: { metadata+: { initializers+: { result+: { code: code } } } } },
          withKind(kind): { jobTemplate+: { metadata+: { initializers+: { result+: { kind: kind } } } } },
          withMessage(message): { jobTemplate+: { metadata+: { initializers+: { result+: { message: message } } } } },
          withMetadata(metadata): { jobTemplate+: { metadata+: { initializers+: { result+: { metadata: metadata } } } } },
          withReason(reason): { jobTemplate+: { metadata+: { initializers+: { result+: { reason: reason } } } } }
        },
        withPending(pending): { jobTemplate+: { metadata+: { initializers+: { pending: if std.isArray(v=pending) then pending else [pending] } } } },
        withPendingMixin(pending): { jobTemplate+: { metadata+: { initializers+: { pending+: if std.isArray(v=pending) then pending else [pending] } } } }
      },
        ...
        metadata: {
          ...
          initializers: {
            ...
            result: {
              // StatusDetails is a set of additional properties that MAY be set by the server to provide additional information about a response. The Reason field of a Status object defines what attributes will be set. Clients must ignore fields that do not match the defined type of each attribute, and should assume that any attribute may be empty, invalid, or under defined.
              details: {
                withCauses(causes): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { causes: if std.isArray(v=causes) then causes else [causes] } } } } } } } },
                withCausesMixin(causes): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { causes+: if std.isArray(v=causes) then causes else [causes] } } } } } } } },
                withGroup(group): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { group: group } } } } } } } },
                withKind(kind): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { kind: kind } } } } } } } },
                withName(name): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { name: name } } } } } } } },
                withRetryAfterSeconds(retryAfterSeconds): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { retryAfterSeconds: retryAfterSeconds } } } } } } } },
                withUid(uid): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { details+: { uid: uid } } } } } } } }
              },
              withCode(code): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { code: code } } } } } } },
              withKind(kind): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { kind: kind } } } } } } },
              withMessage(message): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { message: message } } } } } } },
              withMetadata(metadata): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { metadata: metadata } } } } } } },
              withReason(reason): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { result+: { reason: reason } } } } } } }
            },
            withPending(pending): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { pending: if std.isArray(v=pending) then pending else [pending] } } } } } },
            withPendingMixin(pending): { jobTemplate+: { spec+: { template+: { metadata+: { initializers+: { pending+: if std.isArray(v=pending) then pending else [pending] } } } } } }
          },
